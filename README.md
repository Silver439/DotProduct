...
* 测试结果如下：
   ...
   * ![Screenshot 2020-10-18 191828](DotProduct/picture/Screenshot 2020-10-18 191828.png)
   * ![Screenshot 2020-10-18 192930](DotProduct/picture/Screenshot 2020-10-18 192930.png)
 ...
 * 以下是一些异常输入以及对应的输出结果：
   ...
   * ![Screenshot 2020-10-18 193550](DotProduct/picture/Screenshot 2020-10-18 193550.png)
   * ![Screenshot 2020-10-18 193636](DotProduct/picture/Screenshot 2020-10-18 193636.png)
   * ![Screenshot 2020-10-18 193659](DotProduct/picture/Screenshot 2020-10-18 193659.png)
   * ![Screenshot 2020-10-18 202056](DotProduct/picture/Screenshot 2020-10-18 202056.png)
 * 以上便是对输入异常处理的部分。
#### 计算部分：
* 计算采用分组的方法，先将两个向量的各个分量存入两个动态数组，再每十个为一组进行运算。最后再计算余下的小于十个的部分。代码如下：
  ...
  ```
   * 结果测试：
   * ![Screenshot 2020-10-18 193735](DotProduct/picture/Screenshot 2020-10-18 193735.png)
   * ![Screenshot 2020-10-18 201414](DotProduct/picture/Screenshot 2020-10-18 201414.png)
